...
namespace CableInventoryDLL {
    ...
    public partial class CableReelIDDataSet : global::System.Data.DataSet {
        ...
        public partial class cablereelidDataTable : global::System.Data.TypedTableBase<cablereelidRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public cablereelidRow AddcablereelidRow(System.DateTime TransactionDate, int PartID, int EmployeeID) {
...
namespace CableInventoryDLL.CableReelIDDataSetTableAdapters {
    ...
    public partial class cablereelidTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[cablereelid] WHERE (([CableReelID] = @Original_CableReelID) AN" +
                "D ([TransactionDate] = @Original_TransactionDate) AND ([PartID] = @Original_Part" +
                "ID) AND ([EmployeeID] = @Original_EmployeeID))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[cablereelid] ([TransactionDate], [PartID], [EmployeeID]) VALUE" +
                "S (@TransactionDate, @PartID, @EmployeeID);\r\nSELECT CableReelID, TransactionDate" +
                ", PartID, EmployeeID FROM cablereelid WHERE (CableReelID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[cablereelid] SET [TransactionDate] = @TransactionDate, [PartID] = @PartID, [EmployeeID] = @EmployeeID WHERE (([CableReelID] = @Original_CableReelID) AND ([TransactionDate] = @Original_TransactionDate) AND ([PartID] = @Original_PartID) AND ([EmployeeID] = @Original_EmployeeID));
SELECT CableReelID, TransactionDate, PartID, EmployeeID FROM cablereelid WHERE (CableReelID = @CableReelID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CableReelID, TransactionDate, PartID, EmployeeID FROM dbo.cablereelid";
        ...
        public virtual int Insert(System.DateTime TransactionDate, int PartID, int EmployeeID) {
        ...
        public virtual int Update(System.DateTime TransactionDate, int PartID, int EmployeeID, int Original_CableReelID, System.DateTime Original_TransactionDate, int Original_PartID, int Original_EmployeeID, int CableReelID) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_CableReelID));
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(CableReelID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime TransactionDate, int PartID, int EmployeeID, int Original_CableReelID, System.DateTime Original_TransactionDate, int Original_PartID, int Original_EmployeeID) {
            return this.Update(TransactionDate, PartID, EmployeeID, Original_CableReelID, Original_TransactionDate, Original_PartID, Original_EmployeeID, Original_CableReelID);
        }
    }
